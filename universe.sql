...
CREATE TABLE public.galaxy (
    ...
    dimension_by_light_year text,
    discovery_year character varying(4),
...
CREATE TABLE public.spectral_class (
    ...
    color text,
    average_mass_sun_1 numeric(3,1),
    approx_surface_temperature text,
    average_radius_sun_1 numeric(3,1),
    average_luminousity_sun_1 numeric,
...
SELECT pg_catalog.setval('public.spectral_class_spectral_class_id_seq', 1, false);
...
--
-- Name: spectral_class uniquectm_const; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.spectral_class
    ADD CONSTRAINT uniquectm_const UNIQUE (type);
